package club.acidity.antigamingchair.data;

import club.acidity.antigamingchair.AntiGamingChair;
import club.acidity.antigamingchair.check.ICheck;
import club.acidity.antigamingchair.check.impl.aimassist.AimAssistA;
import club.acidity.antigamingchair.check.impl.aimassist.AimAssistB;
import club.acidity.antigamingchair.check.impl.aimassist.AimAssistC;
import club.acidity.antigamingchair.check.impl.autoclicker.*;
import club.acidity.antigamingchair.check.impl.badpackets.*;
import club.acidity.antigamingchair.check.impl.fly.FlyA;
import club.acidity.antigamingchair.check.impl.fly.FlyB;
import club.acidity.antigamingchair.check.impl.fly.FlyC;
import club.acidity.antigamingchair.check.impl.inventory.InventoryA;
import club.acidity.antigamingchair.check.impl.inventory.InventoryB;
import club.acidity.antigamingchair.check.impl.killaura.*;
import club.acidity.antigamingchair.check.impl.range.RangeA;
import club.acidity.antigamingchair.check.impl.timer.TimerA;
import club.acidity.antigamingchair.check.impl.velocity.VelocityA;
import club.acidity.antigamingchair.check.impl.velocity.VelocityB;
import club.acidity.antigamingchair.check.impl.velocity.VelocityC;
import club.acidity.antigamingchair.check.impl.velocity.VelocityD;
